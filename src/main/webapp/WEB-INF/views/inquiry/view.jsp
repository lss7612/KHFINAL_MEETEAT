...
<div class="text-center">
	<a href="/inquiry/list"><button class="btn btn-primary">목록</button></a>
	...
	<c:if test="${result.USER_NICK eq sessionScope.user_nick || user_grade eq 0}">
		...
		<button class="btn btn-primary">답글</button></a>
		<a href="/inquiry/modify?board_no=${result.BOARD_NO }&article_no=${result.ARTICLE_NO }"><button class="btn btn-warning">수정</button> </a>
		<a href="/inquiry/delete?board_no=${result.BOARD_NO }&article_no=${result.ARTICLE_NO }"><button class="btn btn-danger">삭제</button> </a>
	</c:if>
</div>
